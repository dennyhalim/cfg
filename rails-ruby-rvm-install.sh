...
# sudo yum install -y autoconf automake bison gcc-c++ libtool sqlite-devel readline-devel sqlite-devel zlib-devel openssl-devel ImageMagick-devel
# these might need epel repo:
# sudo yum install -y libffi-devel libyaml-devel
