...
Register-ScheduledJob -Name checkpoint -ScriptBlock {Checkpoint-Computer -Description 'dennyhalim.com'} -Trigger @{Frequency="Daily"; At="11:00AM"} -ScheduledJobOption @{RunElevated=$True}
