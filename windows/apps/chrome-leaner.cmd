...
start "cr" /low /max chrome.exe --process-per-site --renderer-process-limit=1 --TotalMemoryLimitMb=1024 --disk-cache-size=123456789 
rem chrome as app
rem chrome.exe --start-maximized --disable-extensions --app=https://denny.wordpress.com 
rem chrome.exe --disable-extensions --kiosk https://denny.wordpress.com
