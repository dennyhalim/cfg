...
compact.exe /f /i /c C:\ProgramData\Microsoft\ c:\Users "C:\Program Files (x86)" C:\Windows\Temp C:\Windows\assembly C:\Windows\ServiceProfiles\LocalService\AppData\Local\Temp\ C:\Windows\Installer
...
rem reg.exe add "HKLM\DEFAULT\Software\Microsoft\Windows\CurrentVersion\RunOnce" /v epicsetup /t REG_SZ /D "%WINDIR%\Setup\Files\mini_installer.exe" /F
...
schtasks.exe /change /TN "\Microsoft\Windows\Application Experience\Microsoft Compatibility Appraiser Exp" /DISABLE
